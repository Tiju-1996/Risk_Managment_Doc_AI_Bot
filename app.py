...
# -- Risk/Audit Module --
    ...
    # ──────────────────────────────────────────────────────────────
    #llm_audit = ChatNVIDIA(model="meta/llama-3.3-70b-instruct",api_key= NVIDIA_API_KEY,temperature=0, max_tokens=1024)
    llm_audit = ChatNVIDIA(model="ibnzterrell/Meta-Llama-3.3-70B-Instruct-AWQ-INT4",base_url="http://insights.aurex.ai/",temperature=0,max_tokens=1024, top_p=0.1,seed=42)
